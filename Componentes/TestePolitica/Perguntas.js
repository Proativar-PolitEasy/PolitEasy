...
let numpergunta = 0;
let txtpergunta = [
    'Para você, o que mais importa em uma sociedade é o lucro.',
    '2',
    '3',
    '4',
    '5',];
            ...
            <View style={{width:'100%', height:'100%', backgroundColor:'#16abb2'}}>
                ...
                <View style={{height:'71%', width:'100%', backgroundColor:'#16abb2', justifyContent:'center', alignItems:'center'}}>
                    <View style={{height:'100%', width:'100%', alignItems:'center',}}>
                        ...
                        <View style={{height:'20%', width:'90%', borderRadius:10, backgroundColor:'lightblue', marginTop:'20%', borderColor:'black', borderWidth:2,}}>
                            <Text style={{textAlignVertical:'center', textAlign:'center'}}>{txtpergunta[0]}</Text>
                        </View>
